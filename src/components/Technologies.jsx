...
const TECHS = [
    ...
    { Icon: SiApachespark, color: "text-orange-600 dark:text-orange-500", duration: 2.8, label: "Spark", glow: "shadow-orange-500/40" },
    ...
    { Icon: SiKubernetes, color: "text-blue-600 dark:text-blue-500", duration: 4.2, label: "Kubernetes", glow: "shadow-blue-500/40" },
    ...
    { Icon: SiMongodb, color: "text-green-600 dark:text-green-500", duration: 5.0, label: "MongoDB", glow: "shadow-green-500/40" },
